...
const getRaffleData = async (
  ...
  const request = {
    ...
    method: 'GET',
    url:
      `https://g1ik5r2vf5.execute-api.eu-west-1.amazonaws.com/Prod/api/configurations?onlyInfo=true&cacheBust=${ 
      r}`,
...
const getRaffleJSON = async (
  ...
  const request = {
    ...
    method: 'GET',
    url:
      `https://g1ik5r2vf5.execute-api.eu-west-1.amazonaws.com/Prod/api/configurations?cacheBust=${ 
      r}`,
    path: `//Prod/api/configurations?onlyInfo=true&cacheBust=${  r}`,
    proxy: proxyconfig,
    headers: {
