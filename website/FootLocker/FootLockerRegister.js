...
const { registerfirst } = require('../Courir/register/registerfirst');
...
async function footlockerRegister(version) {
    ...
    console.log(chalk.rgb(247, 158, 2)("\n FootLocker Instore | Account Gen"))
    console.log("-----------------------------------------------------\n")

    for (let i = 0; i < 200; i++) {
        registerFTL(proxylist[i],i)
        await sleep(100)
    }
