...
async function raffleXhibition(raffle) {
  ...
  raffle = {
    ...
    currentDate: '2021-07-15T07:02:00.000-05:00',
    campaignId: 'HFMUrCUOpWA2JI0eZF1i',
    dataLogin: {
      SID: '-O-F17KdtyXIEPI0oz7Qgg',
      gsessionid: 'Nn_cZk78X9u__QWWuyyJwhENJbboE394Xa1egluM-Hs'
    },
    type: 'Online',
    status: 'open',
    models: 'QzithTNpjLNM5Mj5fII9',
    modelName: 'Electro Orange',
  ...
  xhibitionEntry2(proxyConfig, user)
  ...
  // await xhibitionEntry3(proxyConfig, user, raffle)
